...
dt_temp<-Generar_taula_plana(dt=dt_index, cataleg = conductor_codis2,parametres = conductor_codis2, sheet="parametres")
...
dt_plana2<- dt_index %>% 
  ...
  left_join(dt_temp,by=c("idp","dtindex"))
